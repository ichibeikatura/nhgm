...
(setq niposiKeywords
	...
	("っぽい\\|それで\\|感じ\\|的\\|というか\\|もちろん\\|そんなわけで\\|思う\\|なって" . font-lock-builtin-face);便利っぽいけど多用しないほうが良い気のする言葉、柔らかいの;	
	("\\([あ-ん]\\{24,\\}\\)" . font-lock-builtin-face);24文字以上続くひらがな、読みにくい場合が多い。
	("[てをがにはのばで][てをがにはのばで]" . font-lock-builtin-face);てにをはの連続、コピペ多用すると間違えやすい。
	("\\([てをがにはのばで]\\)\\1" . font-lock-warning-face);ががををにに、など。ほぼ間違いなので強調表示。
